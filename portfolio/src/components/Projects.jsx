...
const Projects = () => {
    ...
    const projects = [
        ...
        demoPreview: 'https://emessbuy.netlify.app',
        stack: {
          react: "ReactJs",
          tl: "TailwindCss",
          js: "JavaScript",
          ...
          {projects.map((project, i) => {
            return (
              <Link to={project.demoPreview} className="xl:flex items-center w-[%] p-2 gap-4 rounded-xl bg- hover:bg-[#12100E]">
                ...
                <div className="flex flex-col items-center xl:items-start gap ">
                  <span className=" group text-[12px] mt-2 text-[#a1a1aa]">
                    {project.area}
                ...
                <div className="bg-[#212121] flex items-center flex-col gap-4 rounded-xl p-4  w-[%]">
                  <img src={project.img} className="" alt="Rcc project img" />
                  <div className="mt-auto  p-0 flex flex-col ">
